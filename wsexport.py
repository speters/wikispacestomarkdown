...
outputfilename = "%s.files.gitfastimport" % spacename
outputwikiname = "%s.wiki.gitfastimport" % spacename
            ...
            for row in reader:
                ...
                if i == 0:
                    ...
                    if fileinfo['Type'] == 'file':
                        ...
                        html = urllib2.urlopen("http://%s.wikispaces.com/file/history/%s" % (space.name, fileinfo['Name'].encode('utf8'))).read()
                        ...
                        for historyrow in historyrows:
                            ...
                            if not fileuser in memberdict:
                                memberdict[fileuser] = userApi.getUser(session, fileuser)
